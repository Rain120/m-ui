...
interface ExclamationCircleProps extends IconSizeProps, CustomProps, CustomIconProps {
  type: string;
}

export class ExclamationCircle extends Component<ExclamationCircleProps> {
  static defaultProps = {
